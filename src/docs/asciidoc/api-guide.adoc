...
operation::step2_read_events[snippets='response-fields,curl-request,http-response']
...
operation::step1_create_event[snippets='request-fields,curl-request,http-response']
...
operation::step4_read_event[snippets='response-fields,curl-request,http-response']
...
include::{snippets}/step_3_update_event/request-fields.adoc[]
...
operation::step_5_delete_event[snippets='response-fields,curl-request,http-response']
